...
#define USE_TIMER TIMER_FTM0
    ...
    volatile FTM_t *const timer = (FTM_t *)timerAddr;
   // __builtin_constant_p((FTM_t *)timerAddr) ? (FTM_t *)timerAddr : (FTM_t *)timerAddr; // base address for register block of selected timer
